...
exports.Formats = [
	...
	},
	{
		...
		ruleset: [ '+Past', 'Dynamax Clause', 'Obtainable', 'Sleep Clause Mod', 'Species Clause', 'Moody Clause', 'Evasion Moves Clause', 'Endless Battle Clause', 'HP Percentage Mod', 'Cancel Mod', 'Team Preview', 'Swagger Clause', 'Baton Pass Clause', '-Uber'],
		banlist: ['All Pokemon', 'Venusaur-Mega', 'Charizard-MegaX', 'Charizard-MegaY', 'Blastoise-Mega', 'Alakazam-Mega', 'Gengar-Mega', 'Kangaskhan-Mega', 'Pinsir-Mega', 'Gyarados-Mega', 'Aerodactyl-Mega', 'Mewtwo-MegaX', 'Mewtwo-MegaY', 'Ampharos-Mega', 'Scizor-Mega', 'Heracross-Mega', 'Houndoom-Mega', 'Tyranitar-Mega', 'Blaziken-Mega', 'Gardevoir-Mega', 'Mawile-Mega', 'Aggron-Mega', 'Medicham-Mega', 'Manectric-Mega', 'Banette-Mega', 'Absol-Mega', 'Garchomp-Mega', 'Lucario-Mega', 'Abomasnow-Mega'],
		unbanlist: [
