...
//   		},
	...
	},
	{
		...
		onChangeSet(set) {
			if (set.species === 'Chomplim-Mega' || set.species === 'Chomplim') {
				set.species = 'Chomplim';
				set.ability = 'Rough Result';
			}
			if (set.species === 'Silvino-Mega' || set.species === 'Silvino') {
				set.species = 'Silvino';
				set.ability = 'Null System';
			}
			if (set.species === 'Silvino-Bug-Mega' || set.species === 'Silvino-Bug') {
				set.species = 'Silvino-Bug';
				set.ability = 'Null System';
			}
			if (set.species === 'Silvino-Dark-Mega' || set.species === 'Silvino-Dark') {
				set.species = 'Silvino-Dark';
				set.ability = 'Null System';
			}
			if (set.species === 'Silvino-Dragon-Mega' || set.species === 'Silvino-Dragon') {
				set.species = 'Silvino-Dragon';
				set.ability = 'Null System';
			}
			if (set.species === 'Silvino-Electric-Mega' || set.species === 'Silvino-Electric') {
				set.species = 'Silvino-Electric';
				set.ability = 'Null System';
			}
			if (set.species === 'Silvino-Fairy-Mega' || set.species === 'Silvino-Fairy') {
				set.species = 'Silvino-Fairy';
				set.ability = 'Null System';
			}
			if (set.species === 'Silvino-Fighting-Mega' || set.species === 'Silvino-Fighting') {
				set.species = 'Silvino-Fighting';
				set.ability = 'Null System';
			}
			if (set.species === 'Silvino-Fire-Mega' || set.species === 'Silvino-Fire') {
				set.species = 'Silvino=Fire';
				set.ability = 'Null System';
			}
			if (set.species === 'Silvino-Flying-Mega' || set.species === 'Silvino-Flying') {
				set.species = 'Silvino-Flying';
				set.ability = 'Null System';
			}
			if (set.species === 'Silvino-Ghost-Mega' || set.species === 'Silvino-Ghost') {
				set.species = 'Silvino-Ghost';
				set.ability = 'Null System';
			}
			if (set.species === 'Silvino-Grass-Mega' || set.species === 'Silvino-Grass') {
				set.species = 'Silvino-Grass';
				set.ability = 'Null System';
			}
			if (set.species === 'Silvino-Ground-Mega' || set.species === 'Silvino-Ground') {
				set.species = 'Silvino-Ground';
				set.ability = 'Null System';
			}
			if (set.species === 'Silvino-Ice-Mega' || set.species === 'Silvino-Ice') {
				set.species = 'Silvino-Ice';
				set.ability = 'Null System';
			}
			if (set.species === 'Silvino-Poison-Mega' || set.species === 'Silvino-Poison') {
				set.species = 'Silvino-Poison';
				set.ability = 'Null System';
			}
			if (set.species === 'Silvino-Psychic-Mega' || set.species === 'Silvino-Psychic') {
				set.species = 'Silvino-Psychic';
				set.ability = 'Null System';
			}
			if (set.species === 'Silvino-Rock-Mega' || set.species === 'Silvino-Rock') {
				set.species = 'Silvino-Rock';
				set.ability = 'Null System';
			}
			if (set.species === 'Silvino-Steel-Mega' || set.species === 'Silvino-Steel') {
				set.species = 'Silvino-Steel';
				set.ability = 'Null System';
			}
			if (set.species === 'Silvino-Water-Mega' || set.species === 'Silvino-Water') {
