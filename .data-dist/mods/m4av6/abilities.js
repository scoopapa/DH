"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }const bladeMoves = [
...
*/
	...
	vajra: {
		...
		onModifyType(move, pokemon) {
			...
			if (move.type === 'Dark' && !noModifyType.includes(move.id) && !(move.isZ && move.category !== 'Status')) {
				move.type = 'Electric';
				(move ).vajraBoosted = true;
			}
		},
		onBasePowerPriority: 23,
		onBasePower(basePower, pokemon, target, move) {
			if ((move ).vajraBoosted) return this.chainModify([0x1333, 0x1000]);
		},
		name: "Vajra",
		rating: 4,
		num: -1061,
	...
	elegance: {
		...
		onModifyMove(move, attacker) {
			...
			if (_optionalChain([move, 'access', _3 => _3.self, 'optionalAccess', _4 => _4.chance])) move.self.chance = 100;
		},
		name: "Elegance",
		rating: 5,
		num: -1044,
