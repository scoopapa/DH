      ...
      shortDesc: "Base move affects power. Foes: Inflicted with Heal Block.",
		...
		condition: {
			...
			onTryHeal(damage, target, source, effect) {
				if ((_optionalChain([effect, 'optionalAccess', _3 => _3.id]) === 'zpower') || this.effectData.isZ) return damage;
				return false;
			},
		},
		secondary: null,
	...
	gmaxvegetalsword: {
      ...
      condition: {
          ...
          onStart(target, source, effect) {
              ...
              if (!['imposter', 'psychup', 'transform'].includes(_optionalChain([effect, 'optionalAccess', _4 => _4.id]))) {
          ...
          onRestart(target, source, effect) {
              ...
              if (!['imposter', 'psychup', 'transform'].includes(_optionalChain([effect, 'optionalAccess', _5 => _5.id]))) {
                  this.add('-start', target, 'move: G-Max Vegetal Sword');
              }
          },
