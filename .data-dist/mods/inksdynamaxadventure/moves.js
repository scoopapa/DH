	...
	vinetether: {
		...
		condition: {
			...
			durationCallback(target, source) {
				if (_optionalChain([source, 'optionalAccess', _7 => _7.hasItem, 'call', _8 => _8('gripclaw')])) return 8;
			...
			onTrapPokemon(pokemon) {
				if (_optionalChain([this, 'access', _9 => _9.effectData, 'access', _10 => _10.source, 'optionalAccess', _11 => _11.isActive])) pokemon.tryTrap();
			},
			onEnd(pokemon) {
