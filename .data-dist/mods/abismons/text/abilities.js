"use strict";Object.defineProperty(exports, "__esModule", {value: true}); const AbilitiesText = {
	...
	defibrillator: {
		name: "Defibrillator",
		desc: "This Pokemon uses Heal Bell after successfully using an electric type attacking move.",
		shortDesc: "Summons Heal Bell after using an electric type attacking move.",	
	},
	deltastream: {
		name: "Delta Stream",
	...
	infernalice: {
		name: "Infernal Ice",
		desc: "Turns Ice moves into Fire moves and boosts them by 20%.",
		shortDesc: "Turns Ice moves into Fire moves and boosts them by 20%.",
		
		start: "  [POKEMON]'s ice moves are raging with fire!",
	},
	freezingflames: {
		name: "Freezing Flames",
		desc: "Turns Fire moves into Ice moves and boosts them by 20%. Pledge moves are unaffected.",
		shortDesc: "Turns Fire moves into Ice moves and boosts them by 20% Pledge moves are unaffected.",
		
		start: "  [POKEMON]'s fire moves are very chilling!",	
	},
	innardsout: {
		name: "Innards Out",
	...
	skillissue: {
		name: "Skill Issue",
		desc: "This Pokemon is a sore loser, and will use Conversion 2 on entry to win.",	
		
		start: "  [POKEMON] is cheating!"
	},
	slowstart: {
		name: "Slow Start",
